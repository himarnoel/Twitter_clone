...
class Ptweet extends StatefulWidget {
  const Ptweet({Key? key}) : super(key: key);

  @override
  _PtweetState createState() => _PtweetState();
}

class _PtweetState extends State<Ptweet> {
  String username = "";
  @override
  void initState() {
                      ...
                      if (snapshot.hasData) {
                        return ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              List color = ds["likes"];
                              return _auth.currentUser!.uid != ds["uid"]
